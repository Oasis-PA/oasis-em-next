...
const headerSrcImagens = [
    'src/Imagens/page3/img-figure1.png',
    'src/Imagens/page3/img-figure2.png',
    'src/Imagens/page3/img-figure3.png',
    'src/Imagens/page3/img-figure4.png',
    'src/Imagens/page3/img-figure5.png',
    'src/Imagens/page3/img-figure6.png',
    'src/Imagens/page3/img-figure7.png',
    'src/Imagens/page3/img-figure8.png',
    'src/Imagens/page3/img-figure9.png',
    'src/Imagens/page3/img-figure10.png',
    'src/Imagens/page3/img-figure11.png',
    'src/Imagens/page3/img-figure12.png'
]
...
const containerCortesEmAlta = document.getElementsByClassName('page3-cortes')
  ...
  cortesEmAltatext[0].addEventListener('click', () => {
    cortesImagens[0].src = 'src/Imagens/page3/img-conheca1.png'
    cortesImagens[1].src = 'src/Imagens/page3/img-conheca2.png'
    cortesImagens[2].src = 'src/Imagens/page3/img-conheca3.png'
    cortesImagens[3].src = 'src/Imagens/page3/img-conheca4.png'
    for(let contador = 0; contador<= 3; contador++)
    {
  ...
  cortesEmAltatext[1].addEventListener('click', () => {
    cortesImagens[0].src = 'src/Imagens/page3/masculino/americano.png'
    cortesImagens[1].src = 'src/Imagens/page3/masculino/lowFade.png'
    cortesImagens[2].src = 'src/Imagens/page3/masculino/mullet.png'
    cortesImagens[3].src = 'src/Imagens/page3/masculino/social.png'
    for(let contador = 0; contador<= 3; contador++)
        {
            containerCortesEmAlta[contador].style.background = "#5F0B38";
        }
    ...
    cortesEmAltatext[2].addEventListener('click', () => {
        cortesImagens[0].src = 'src/Imagens/page3/+50/bobAngular.png'
        cortesImagens[1].src = 'src/Imagens/page3/+50/camadasBorboleta.png'
        cortesImagens[2].src = 'src/Imagens/page3/+50/curto.png'
        cortesImagens[3].src = 'src/Imagens/page3/+50/social.png'
        for(let contador = 0; contador<= 3; contador++)
        {
