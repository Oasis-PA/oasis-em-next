...
<header>
  <section>
    ...
    <div id="page1-header-top">
      ...
      <div id="page1-user">
        <Link href="../../Pesquisa/index.html" target="_blank">
          <Image src="/images/lupa.png" alt="Pesquisae" width={30} height={30} />
        </Link>
        <Link href="../../Favoritos/index.html" target="_blank">
          <Image
        ...
        <Link href="../../Tela-login/index.html" target="_blank">
          <Image
    ...
    <nav id="page1-header-bottom">
      ...
      <table id="tablePenteados" className="tableItensNone">
        <thead>
          <tr>
            <th>
              <Link href="#" className="page1-header-bottom-itens">
                PENTEADOS
              </Link>
            </th>
          </tr>
      ...
      <table id="tableSkinCare" className="tableItensNone">
        <thead>
          <tr>
            <th>
              <Link href="/" className="page1-header-bottom-itens" target="_blank">
                Skincare
              </Link>
            </th>
          </tr>
      ...
      <table id="tableCronogramaCapilar" className="tableItensNone">
        <thead>
          <tr>
            <th>
              <Link href="#" className="textoAmarelo">
                CRONOGRAMA CAPILAR
              </Link>
            </th>
          </tr>
