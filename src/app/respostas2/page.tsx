...
// Certifique-se que o arquivo CSS está na mesma pasta ou ajuste o caminho
  ...
  for (let i = 0; i < 6; i++) {
    ...
    for (let j = 0; j < 7; j++) {
      if ((i === 0 && j < primeiroDia) || dia > diasNoMes) {
        ...
        let bolinha = null;
        if (tratamento) {
          // Acessa styles.dot e styles.hidratacao (por exemplo) dinamicamente
...
const Respostas: React.FC = () => {
  ...
  function getCronogramaSemana() {
    ...
    return diasSemana.map(({ id, nome, dia }) => {
      ...
      return (
        <div id={id} key={id} className={styles.weekDayItem}>
          <h1>{nome}</h1>
          <p>{tipo}</p>
        </div>
      );
        ...
        <div className={styles.contentGrid}>
          ...
          <section className={styles.leftColumn}>
            ...
            <div className={styles.infoCard}>
              {/* Usa duas classes para a imagem: a base e a específica */}
              <div className={`${styles.infoImage} ${styles.infoImage2}`}></div>
              <div className={styles.cardContent}>
                ...
                <section className={styles.detailsList}>
                  <div className={styles.detailItem}>
                    ...
                    <p className={styles.detailValue}>Médio</p>
                  </div>
                  <div className={styles.detailItem}>
                    <div className={styles.detailHeader}>
                    ...
                    <p className={styles.detailValue}>6 Meses</p>
                  </div>
                  <div className={styles.detailItem}>
                    <div className={styles.detailHeader}>
                    ...
                    <p className={styles.detailValue}>Leve</p>
                  </div>
                </section>
              </div>
            </div>
            ...
            <div className={styles.calendarSection}>
              ...
              <div className={styles.calendarContainer}>{gerarCalendario(mesAtual, anoAtual)}</div>
            </div>
          </section>
