            ...
            <main className={styles.mainContainer}>
                ...
                <section className={styles.direita}>
                    <div className={styles.conteudo}>
                        <img src={currentQuestionData.image} alt="Imagem da pergunta" />
                        ...
                        <div className={styles.botoes}>
                            {!isFirstQuestion && (
                                <button onClick={handlePrev} className={styles.numberOne}>
                                    Anterior
                                </button>
                            )}
                            {!isLastQuestion ? (
                                <button onClick={handleNext} className={styles.numberTwo}>
                                    Próximo
                                </button>
                            ) : (
                                <button
                                    onClick={handleSubmitQuiz}
                                    className={`${styles.numberTwo} ${styles.finalizarQuizBtn}`}
                                >
                                    Finalizar Quiz
                                </button>
                            )}
