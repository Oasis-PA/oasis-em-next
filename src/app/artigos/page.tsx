...
const SaveIcon = ({ fill, ...props }: SaveIconProps) => (
  <svg
    ...
    viewBox="0 0 16 22"
    fill="none"
    {...props} // <- permite className, style, onClick etc.
  >
    <path
      d="M14 0H1.75C1.28587 0 0.840752 0.184374 0.512563 0.512563C0.184374 0.840752 0 1.28587 0 1.75V21C7.76971e-05 21.1562 0.0419427 21.3094 0.121251 21.444C0.200559 21.5785 0.31442 21.6893 0.451018 21.765C0.587617 21.8406 0.741976 21.8784 0.898076 21.8743C1.05418 21.8701 1.20633 21.8243 1.33875 21.7416L7.875 17.6564L14.4123 21.7416C14.5447 21.824 14.6968 21.8696 14.8527 21.8736C15.0087 21.8776 15.1628 21.8398 15.2992 21.7642C15.4357 21.6885 15.5494 21.5778 15.6287 21.4434C15.7079 21.3091 15.7498 21.156 15.75 21V1.75C15.75 1.28587 15.5656 0.840752 15.2374 0.512563C14.9092 0.184374 14.4641 0 14 0ZM14 19.4217L8.33766 15.8834C8.19859 15.7965 8.0379 15.7504 7.87391 15.7504C7.70991 15.7504 7.54922 15.7965 7.41016 15.8834L1.75 19.4217V1.75H14V19.4217Z"
      fill={fill || "var(--corpo-texto)"}
    />
  </svg>
);
    ...
    <Header />
      ...
      <main>
        ...
        <section className="seção">
          <SaveIcon fill='black' id='sorriso'/>
          <div id="data" >
            <p>13 jan 2025</p>
          </div>
          <div id="texto">
        ...
        <section className="grupos-linha1">
          <div> 
            ...
            <SaveIcon fill="white"  className="save-icon"/>
