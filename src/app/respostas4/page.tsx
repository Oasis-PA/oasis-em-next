        ...
        <div className={styles.contentGrid}>
          ...
          <section className={styles.leftColumn}>
            ...
            <div className={styles.infoCard}>
              {/* Imagem específica para muito danificado */}
              <div className={`${styles.infoImage} ${styles.infoImage4}`}></div>
              <div className={styles.cardContent}>
                ...
                <section className={styles.detailsList}>
                  <div className={styles.detailItem}>
                    ...
                    <p className={styles.detailValue}>Emergencial</p>
                  </div>
                  <div className={styles.detailItem}>
                    <div className={styles.detailHeader}>
                  ...
                  <div className={styles.detailItem}>
                    ...
                    <p className={styles.detailValue}>Crítico</p>
                  </div>
                </section>
              </div>
            </div>
