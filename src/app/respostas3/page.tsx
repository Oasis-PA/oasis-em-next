  ...
  for (let i = 0; i < 6; i++) {
    ...
    for (let j = 0; j < 7; j++) {
      if ((i === 0 && j < primeiroDia) || dia > diasNoMes) {
        ...
        let bolinha = null;
        if (tratamento) {
          // Classes dinâmicas para as bolinhas
        ...
        <div className={styles.contentGrid}>
          ...
          <section className={styles.leftColumn}>
            ...
            <div className={styles.infoCard}>
              {/* Combina classe base com a classe da imagem específica (infoImage3) */}
              <div className={`${styles.infoImage} ${styles.infoImage3}`}></div>
              <div className={styles.cardContent}>
                ...
                <section className={styles.detailsList}>
                  <div className={styles.detailItem}>
                    ...
                    <p className={styles.detailValue}>Intensivo</p>
                  </div>
                  <div className={styles.detailItem}>
                    <div className={styles.detailHeader}>
                  ...
                  <div className={styles.detailItem}>
                    ...
                    <p className={styles.detailValue}>Alto</p>
                  </div>
                </section>
              </div>
            </div>
