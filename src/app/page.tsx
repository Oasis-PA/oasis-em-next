    ...
    <div id="bodyPaginaPrincipal" className="min-h-screen">
      ...
      <div id="page1" className="relative">
        <header id="page1Header">
          <section id="page1HeaderSection">
            <div id="page1-header-top" className="flex justify-between items-center p-4">
              ...
              <div id="page1-user" className="flex gap-4">
                <Link href="/pesquisa" className="page1UserLinks">
                  <Image 
                ...
                <Link href="/favoritos" className="page1UserLinks">
                  <Image 
                    className="page1UserImg" 
            ...
            <nav id="page1-header-bottom" className="relative">
              {/* Table Cortes */}
              <table 
                id="tableCortes" 
                className={activeTable === 'cortes' ? '' : 'hidden'}
                onMouseEnter={() => handleTableHover('cortes')}
              >
                <thead>
                  <tr>
                    <th>
                      <Link href="/cortes" className="page1-header-bottom-itens">
                        CORTES
                      </Link>
                    </th>
                  </tr>
                  ...
                  <tr className="tr-cabecalho">
                    <th>
                      ...
                      <div id="tr-cabecalho-tamanho-itens">
                        <p className="textoRoxo">Super curto</p>
                        <p className="textoRoxo">Curto</p>
                        <p className="textoRoxo">Médio</p>
                        <p className="textoRoxo">Longo</p>
                        <p className="textoRoxo">Super Longo</p>
                      </div>
                    </th>
                    <th>
                      ...
                      <div id="tr-cabecalho-formato-itens">
                        <div id="tr-cabecalho-formato-item1">
                          <p className="textoRoxo">2A</p>
                          <p className="textoRoxo">2B</p>
                          <p className="textoRoxo">2C</p>
                          <p className="textoRoxo">3A</p>
                          <p className="textoRoxo">3B</p>
                          <p className="textoRoxo">3C</p>
                        </div>
                        <div id="tr-cabecalho-formato-item2">
                          <p className="textoRoxo">4A</p>
                          <p className="textoRoxo">4B</p>
                          <p className="textoRoxo">4C</p>
                        </div>
                      </div>
                    </th>
                    <th>
                      ...
                      <div id="tr-cabecalho-tipo-de-rosto-itens">
                        <p className="textoRoxo">rosto Oval</p>
                        <p className="textoRoxo">Rosto Redondo</p>
                        <p className="textoRoxo">Rosto Coração</p>
                        <p className="textoRoxo">Rosto Quadrado</p>
                        <p className="textoRoxo">Rosto Diamante</p>
                      </div>
                    </th>
                    <th>
              ...
              <table 
                id="tablePenteados" 
                className={activeTable === 'penteados' ? '' : 'hidden'}
                onMouseEnter={() => handleTableHover('penteados')}
              >
                <thead>
                  <tr>
                    <th>
                      <Link href="/pagina-em-manutencao" className="page1-header-bottom-itens">
                        PENTEADOS
                      </Link>
                    </th>
                  </tr>
                ...
                <tbody>
                  <tr className="tr-cabecalho">
                    ...
                    <th>
                      ...
                      <div id="tr-cabecalho-formato-itens">
                        <div id="tr-cabecalho-formato-item1">
                          <p className="textoRoxo">Trança</p>
                          <p className="textoRoxo">Coque</p>
                          <p className="textoRoxo">Com Elástico</p>
                          <p className="textoRoxo">Tradicionais</p>
                          <p className="textoRoxo">Para Festas!</p>
                          <p className="textoRoxo">Com Faixa</p>
                        </div>
                        <div id="tr-cabecalho-formato-item2">
                          <p className="textoRoxo">Com laço</p>
                          <p className="textoRoxo">Para O Trabalho</p>
                          <p className="textoRoxo">Para quem está em transição</p>
                          <p className="textoRoxo">twist</p>
                          <p className="textoRoxo">com presilha</p>
                          <p className="textoRoxo">baby hair</p>
                        </div>
                      </div>
                    </th>
                    <th>
              ...
              <table 
                id="tablecoloracao" 
                className={activeTable === 'coloracao' ? '' : 'hidden'}
                onMouseEnter={() => handleTableHover('coloracao')}
              >
                <thead>
                  <tr>
                    <th>
              ...
              <table 
                id="tableSkinCare" 
                className={activeTable === 'skincare' ? '' : 'hidden'}
                onMouseEnter={() => handleTableHover('skincare')}
              >
                <thead>
                  <tr>
                    <th>
              ...
              <table 
                id="tableCronogramaCapilar" 
                className={activeTable === 'cronograma' ? '' : 'hidden'}
                onMouseEnter={() => handleTableHover('cronograma')}
              >
                <thead>
                  <tr>
                    <th>
                      <Link href="/pagina-em-manutencao" className="textoAmarelo">
                        CRONOGRAMA CAPILAR
                      </Link>
                    </th>
                  </tr>
              ...
              {/* Table Recomendações */}
              <table 
                id="tableRecomendacoes" 
                className={activeTable === 'recomendacoes' ? '' : 'hidden'}
                onMouseEnter={() => handleTableHover('recomendacoes')}
              >
                <thead>
                  <tr>
                    <th>
      ...
      <div id="page3" className="py-20">
        <header>
          <article className="flex items-center justify-center gap-4 overflow-x-auto px-6">
            <div className="setas">
              <Image 
